...
<?php endif; ?>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview <?=active_link_controller('order')?>">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li class="<?=active_link_function('form_request')?>"><a href="<?php echo site_url('bank/order/form_request'); ?>"><?php echo lang('menu_form_request'); ?></a></li>
                                <li class="<?=active_link_function('to_do_list')?>"><a href="<?php echo site_url('bank/order/to_do_list'); ?>"><?php echo lang('menu_to_do_list'); ?></a></li>
                            </ul>
                        </li>
